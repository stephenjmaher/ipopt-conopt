...
class IPOPTLIB_EXPORT SolveStatistics : public ReferencedObject {
 public:
   SolveStatistics()
       : num_iters_(0), total_cpu_time_(0.0), total_sys_time_(0.0), total_wallclock_time_(0.0),
         num_obj_evals_(0), num_constr_evals_(0), num_obj_grad_evals_(0), num_constr_jac_evals_(0),
         num_hess_evals_(0), scaled_obj_val_(0.0), obj_val_(0.0), scaled_dual_inf_(0.0),
         dual_inf_(0.0), scaled_constr_viol_(0.0), constr_viol_(0.0), scaled_bound_viol_(0.0),
         bound_viol_(0.0), scaled_compl_(0.0), compl_(0.0), scaled_kkt_error_(0.0), kkt_error_(0.0),
   ...
   virtual void NumberOfEvaluations(Index& num_obj_evals, Index& num_constr_evals,
         Index& num_obj_grad_evals, Index& num_constr_jac_evals, Index& num_hess_evals) const {
   ...
   virtual void Infeasibilities(Number& dual_inf, Number& constr_viol, Number& varbounds_viol,
         Number& complementarity, Number& kkt_error) const {
      dual_inf = dual_inf_;
   ...
   virtual void ScaledInfeasibilities(Number& scaled_dual_inf, Number& scaled_constr_viol,
         Number& scaled_varbounds_viol, Number& scaled_complementarity,
   ...
   void SetInfeasibilities(Number dual_inf, Number constr_viol, Number bound_viol,
         Number complementarity, Number kkt_error) {
      dual_inf_ = dual_inf;
   ...
   void SetScaledInfeasibilities(Number scaled_dual_inf, Number scaled_constr_viol,
         Number scaled_bound_viol, Number scaled_complementarity, Number scaled_kkt_error) {
